            ...
            <div class="col-md-12">
                <div class="card card-user">
                    <div class="card-body">
                        ...
                        <form action="{{ route('vacunacion.update', $vacunacione->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
...
{{-- 
                                ...
                                <div class="col-lg-6 col-12">
                                        ...
                                        <input  class="form-control mb-4" type="text" name="medio_admin" value="{{ old('medio_admin',$vacunacione->medio_admin) }}"
                                            required="required">
                                ...
                                <div class="col-lg-6 col-12">
                                        ...
                                        <input class="form-control mb-4" type="text" name="cantidad_usada" value="{{ old('cantidad_usada') }}"
                                            required="required">
                                ...
                                <div class="col-lg-6 col-12">
                                        ...
                                        <input class="form-control mb-4" type="date" name="fecha_realizacion" value="{{ old('fecha_realizacion') }}"
                                            required="required">
                                </div>
                                ...
                                {{-- <div class="col-lg-6 col-12">
                                    ...
                                    <span>usuario</span>
                                    <input  class="form-control mb-4" type="number" name="id_usuario" value="{{ old('id_usuario') }}"
                                        required="required">

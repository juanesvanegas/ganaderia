      ...
      <div class="container">
        <div class="from">
          ...
          <form>
            ...
            <div class="inputBox">
                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Contraseña">
            </div>
